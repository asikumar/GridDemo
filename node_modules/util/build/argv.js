define([
	...
	var
		...
		// we need to know the dojo path and the path to /utilities/buildscripts to process v1.x profiles and profiles in the
		// /utilities/buildscripts/profiles directory
		dojoPath = computePath(require.toUrl("dojo/package.json").match(/(.+)\/package\.json$/)[1], cwd),
		utilBuildscriptsPath = compactPath(catPath(dojoPath, "/../utilities/buildscripts")),
		...
		readProfile = function(
			...
			// contain a ".js" suffix, then it is assumed to be a profile in the /utilities/buildscripts/profile directory
			// `code
