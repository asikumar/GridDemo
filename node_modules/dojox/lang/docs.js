...
(function(){
	function error(error){
		console.log("Warning, the API docs must be available at ../utilities/docscripts/api.json "+
		"or ../utilities/docscripts/api/*.json "+
	...
	dojox.lang.docs.init = function(/*Boolean*/async){
		...
		function loadFullDocs(){
			...
			try{
				dojo.xhrGet({
					sync:!async,
					url: dojo.baseUrl + '../utilities/docscripts/api.json',
					handleAs: 'text'
		...
		var getSplitDocs = function(moduleName, sync){
			return dojo.xhrGet({
				sync: sync||!async,
				url: dojo.baseUrl + '../utilities/docscripts/api/' + moduleName + '.json',
				handleAs: 'text'
