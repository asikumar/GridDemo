...
/*=====
	utilities.docscripts.tests.simple = {
...
(function(d, $){
	...
	/*=====
	utilities.docscripts.tests.simple.__kwArgs = function(a, b, c){
	...
	d.kwArgFunction = function(/* utilities.docscripts.tests.simple.__kwArgs */args){
