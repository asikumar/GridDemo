define(["dojo", "dojox/math/round"], function(dojo, round){
	...
	var uidMap = {};
	var start = 0;
	//dojox.drawing.utilities.common	=
	return {
		// summary:
		...
		distance: function(/*EventObject or x1,y1,x2,y2*/){
			// summary:
			//		Return the length derived from the coordinates
			//		in the Mouse object. Different from utilities.length
		...
		register: function(/*Object*/obj){
			// summary:
			//		Since utilities is the only Singleton in Drawing (besides
		...
		byId: function(/*String*/id){
			// summary:
			//		Get an object that was registered with utilities.register
		...
		attr: function(/* Object */ elem, /* property */ prop, /* ? value */ value, squelchErrors){
			...
			try{
				...
				// utilities is a crappy check, but we need to tell the diff
