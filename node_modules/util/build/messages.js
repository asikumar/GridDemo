define([], function(){
	var categories = {
		...
		[1, 212, "oddDojoPath", "No profile.basePath provided, yet dojo path is relative and running build with the current working directory different than utilities/buildscripts"],
