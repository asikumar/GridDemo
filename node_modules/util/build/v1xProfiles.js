define([
	...
	var mix = function(dest, src){
		...
		processProfile = function(profile, dojoPath, utilBuildscriptsPath, profilePath){
			...
			//
			//	 * the utilities/buildscripts/ directory is assumed to be the cwd upon build program startup
			//	 * the dojo directory as specified in profile dependencies.prefixes (if relative) is
			//	   assumed to be relative to utilities/buildscripts/; usually, it is not explicitly specified
			//	   and is automatically set by the v1.6 build application to ../../dojo.
			//	 * similarly the releaseDir directory (if relative) is assumed to be relative to utilities/buildscripts/
			...
			//
			// This has the net effect of forcing the assumption that build program is be executed from utilities/buildscripts.
			...
			// in this case, basePath in v1.6- is always assumed to be /utilities/buildscripts
			...
			// now fixup and make absolute the releaseDir; releaseDir, if relative, is relative to /utilities/buildscripts
