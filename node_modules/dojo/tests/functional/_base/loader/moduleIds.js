	...
	registerSuite({
		...
		testModuleIds: loaderTest(
			...
			function (callback) {
				...
				check(get('..', refmod), 'pack1', 'main', pack1Root + 'main');
				check(get('../myModule', refmod), 'pack1', 'myModule', pack1Root + 'myModule');
				check(get('../utilities/myModule', refmod), 'pack1', 'utilities/myModule', pack1Root + 'utilities/myModule');
		...
		modulePaths: loaderTest(
			...
			function (callback) {
				require(['dojo'], function (dojo) {
					...
					callback({
						expectedUtilUrl: require.compactPath(require.baseUrl + '../some/path/mycoolpath/utilities/'),
