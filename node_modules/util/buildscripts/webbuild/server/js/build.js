...
build = {
	make: function(
		...
		var buildscriptDir = dojoDir + "utilities/buildscripts/";
		
		//Load the libraries to help in the build.
		load(dojoDir + "utilities/buildscripts/jslib/logger.js");
		load(dojoDir + "utilities/buildscripts/jslib/fileUtil.js");
		load(dojoDir + "utilities/buildscripts/jslib/buildUtil.js");
		load(dojoDir + "utilities/buildscripts/jslib/buildUtilXd.js");
		load(dojoDir + "utilities/buildscripts/jslib/i18nUtil.js");
