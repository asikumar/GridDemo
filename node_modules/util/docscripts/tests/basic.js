...
(function(){
	...
	doh.register("doctests.basic", [
		...
		function actual_fetching(t){
			docs = getdata("utilities/docscripts/tests/simple.js");
			t.t(docs);
...
//			docs = getdata("utilities/docscripts/tests/simple_amd.js");
//			console.warn("amd-basic", docs);
//		},
//		
//		function fetch_amd_declare(t){
//			docs = getdata("utilities/docscripts/tests/declare_amd.js");
//			console.warn("amg-declare", docs);
//		},
		
		function functional(t){
			// refs #13345
			docs = getdata("utilities/docscripts/tests/functional.js");
		...
		function raw_declare_init(t){
			docs = getdata("utilities/docscripts/tests/extend_declare.js");
			t.t(true);
		},
