(function(){
	var
		boot =
			...
			// i.e. path-to-utilities/doh/runner.html?boots=path-to/config.js,path-to/require.js
			["../../dojo/dojo.js"],
		...
		test =
			...
			// For example, the URL...
			//
			//		 path-to-utilities/doh/runner.html?test=doh/selfTest,my/path/test.js
			//
			// ...will load...
			//
		...
		paths = 
			...
			// i.e. path-to-utilities/doh/runner.html?paths=my/from/path,my/to/path;my/from/path2,my/to/path2
			{},
	...
	if(sandbox){
		...
		config= {
			...
			paths: paths,
			packages: [
				{ name: 'doh', location: 'utilities/doh' },
